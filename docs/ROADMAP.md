...
| Reconciliation | In progress | Deterministic matching, confidence, manual review and history | Invoice receipts and tenant-safe Stripe payout allocation work; reviewed payout-to-bank confirmation is next |
