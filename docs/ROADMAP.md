...
| Reconciliation | In progress | Deterministic matching, confidence, manual review and history | Exact incoming bank payments can be reviewed against issued invoices; wider matching rules, partial payments, and provider payouts still need work |
