...
| Frontend | In progress | React/TypeScript authentication and organization setup are working; invoices, payments, banking, review, ledger and dashboards follow | Type/lint/build checks pass; live identity/organization workflow checked through the API proxy; responsive loading/empty/error states included; no frontend secrets |
