...
- [Fake bank setup](docs/PLAID_SANDBOX.md)
...
This checks Java formatting, compiles the app, runs 31 focused tests, packages an executable JAR, and runs 83 integration tests against isolated PostgreSQL through Testcontainers. Integration tests fail if Docker is unavailable rather than silently skipping.
